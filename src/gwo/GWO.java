...
//                    System.out.println("swap "+entry.getKey().toString());
//                    System.out.println("scheduleInPopulation:" + scheduleInPopulation.fitness +"-------is finsished:"+scheduleInPopulation.isAccepted());
